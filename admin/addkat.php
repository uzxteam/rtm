                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form method="POST" action="form/kategoriya.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="text" name="kategoriya" class="form-control input-default" placeholder="Kategoriya nomi">
                                </div>
