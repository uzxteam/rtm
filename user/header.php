...
<body>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./index.php">Kitob yuklash</a></li>
                        
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Kitoblar</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="otm.php">Tastiqlangan</a></li>
                            <li><a href="otm.php">Tastiqlanmagan</a></li>
    ...
    while ($row = mysqli_fetch_array($user)) {
       echo " <li><a href='addkat.php?id=".$row['id']."'>Adsense</a></li>";
